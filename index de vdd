...
<body>
    ...
    <p class="lead"> Oie! Eu sou a Mary</p>
    <h1>Freud Explica!</h1>
    <p>Meu nome é Mariany Rodrigues Alves, tenho 17 anos, sou estudante do terceiro ano do ensino médio e futura pscicóloga. Desejo me aprofundar na área clínica e abrir meu próprio consultório. </p>
    <p>Minhas habilidades</p>
    <div>
            <p class="badge bg-secondary">Paciência</p>
            <p class="badge bg-secondary">observação</p>
            <p class="badge bg-secondary">Empatia</p>
            <p class="badge bg-secondary">Resiliência</p>
            <p class="badge bg-secondary">Boa Escuta</p>
            <p class="badge bg-secondary">Senso Crítico</p>
    </div>
</body>
         ...
         <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Feira de Profissões: Psicanálise  </h5>
                        <p class="card-text"> A "VII feira de Profissões" foi um projeto pedagógico realizado na escola Ivete Sala de Queiroz, no dia 29 de setembro de 2023, pelos alunos do primeiro ano do ensino médio. A feira tinha como propósito explorar as áreas de conhecimento sobre o Projeto de Vida de cada um dos estudantes e apresentar as pesquisas feitas. Nossa exposição teve como foco a Psicanálise, uma abordagem psicoterapêutica e um método de investigação da psique humana, focada na compreensão e tratamento dos processos inconscientes que influenciam o comportamento e as emoções.
                        </p>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Principais Inspirações</h5>
                        <p class="card-text">Aqui estão minhas principais inspirações para seguir essa profissão tão desafiadora,</p>
                        <button type="button" class="btn btn-link">Veja o projeto</button>
                    </div>
                </div>
            </div>
